...
const Navbar = (props: Props) => {
  ...
  const SignOut = () => {
    if (session && session.user) {
      return (
        <ul className="py-5 px-1 text-neutral-600">
          ...
          <li className="whitespace whitespace-nowrap hover:bg-gray-100 hover:text-neutral-900 px-5 py-2 cursor-pointer">
    ...
    return (
      <ul>
        <li
          className="whitespace whitespace-nowrap hover:bg-gray-100 hover:text-neutral-900 px-5 py-2 cursor-pointer"
          onClick={() => signIn()}
        >
          Sign In
        </li>
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="bg-gray-100 items-center flex p-2 rounded-lg my-4 py-3">
          {" "}
          <input
            type="text"
            placeholder="Search"
            autoComplete="false"
            className="w-full outline-none bg-transparent ml-2 text-[15px] caret-blue-500 placeholder:font-light placeholder:text-gray-600"
          />
          <button>
